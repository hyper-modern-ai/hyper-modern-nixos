    ...
    [
      (st.overrideAttrs (oldAttrs: rec {
        ...
        patches = [
          ...
          (fetchpatch {
            url =
              "https://st.suckless.org/patches/scrollback/st-scrollback-reflow-0.9.diff";
          ...
          (fetchpatch {
            url =
              "https://st.suckless.org/patches/blinking_cursor/st-blinking_cursor-20230819-3a6d6d7.diff";
            sha256 = "sha256-f79RFl4JFKNF4cAl8WsfNC2Zx5nd8lQ8TuSxl2rBxfY==";
          })
          (fetchpatch {
            url =
              "https://st.suckless.org/patches/ligatures/0.9/st-ligatures-scrollback-20230105-0.9.diff";

...
main() {
	...
	ssh "root@${IP}" <<EOF
      ...
      mkdir -p /mnt/home/b7r6/.ssh
EOF
	pass "machine/${MACHINE}/b7r6/ssh/private-key" | ssh "root@${IP}" 'cat > /mnt/home/b7r6/.ssh/id_ed25519'
	pass "machine/${MACHINE}/b7r6/ssh/public-key" | ssh "root@${IP}" 'cat > /mnt/home/b7r6/.ssh/id_ed25519.pub'
	ssh "root@${IP}" <<EOF
      chmod -R 700 /mnt/home/b7r6/.ssh
      chown -R 1000:100 /mnt/home/b7r6/.ssh
EOF
	...
	# Copy GPG
	rsync -chavzP /home/b7r6/.gnupg "root@${IP}:/mnt/home/b7r6/"
